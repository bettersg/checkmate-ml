...
plan_next_step_definition = dict(
    ...
    parameters={
        ...
        "properties": {
            ...
            "next_step": {
                "type": "STRING",
                "description": "What the nexthit step should be. You can either search_google to investigate claims, get_website_screenshot to see the contents of a link, or submit_community_note once you have enough information to complete your task. Avoid performing more than 5 searches.",
                "enum": [
                    "search_google",
